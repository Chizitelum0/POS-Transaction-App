...
const styles = {
  ...
  productsSection: { flex: '2', minWidth: '300px' },
  cartSection: {
    flex: '1',
    minWidth: '280px',
    background: '#ffffff',
  ...
  sectionTitle: { margin: '0 0 16px 0', fontSize: '16px', color: '#334155' },
  grid: {
    display: 'grid',
  ...
  cartItemsContainer: { minHeight: '200px', flex: 1 },
  cartRow: {
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  cartFooter: { marginTop: '20px', borderTop: '1px solid #e2e8f0', paddingTop: '16px' },
  totalRow: {
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
